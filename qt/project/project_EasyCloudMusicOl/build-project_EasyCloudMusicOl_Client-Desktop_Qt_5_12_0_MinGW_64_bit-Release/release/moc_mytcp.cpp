...
#include "../../project_EasyCloudMusicOl_Client/mytcp.h"
...
QT_MOC_LITERAL(1, 6, 14), // "recvTcpJsonObj"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "jsonObj"
QT_MOC_LITERAL(4, 30, 8), // "sendData"
QT_MOC_LITERAL(5, 39, 8) // "recvData"

    },
    "MyTcp\0recvTcpJsonObj\0\0jsonObj\0sendData\0"
    "recvData"
};
...
void MyTcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recvTcpJsonObj((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 1: _t->sendData((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MyTcp::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcp::recvTcpJsonObj)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcp::recvTcpJsonObj(QJsonObject _t1)
{
